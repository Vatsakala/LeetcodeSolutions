--- READ ABOUT WINDOW FUNCTION
--- Write your MySQL query statement below USING JOIN
SELECT
...
LEFT JOIN Activity a2
 ...
 AND a2.event_date = a1.first_date + INTERVAL 1 DAY;

--- SOLUTION 2; USINGG WINDOW FUNCTION:
