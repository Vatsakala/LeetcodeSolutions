...
SELECT P1.category as category1, P2.category as category2, COUNT(P1.user_id) AS customer_count
FROM product_with_category P1 JOIN product_with_category P2
